...
public class SalixPharmaceuticalsChrome extends Base_Class {

	SalixPharmaceuticalsPageOjectManager pageObjectManager = new SalixPharmaceuticalsPageOjectManager();

	@BeforeTest
	public void setUp() throws IOException, InterruptedException {
		launchBrowser(pageObjectManager.getFileReader().getDataProperty("Chromebrowser"));
	...
	private void extendStartUp() {
		extentReportStart("F:\\Java_Workspace\\SalixProject\\SalixPharmaceuticals\\Reports");
	}
	@AfterSuite
	private void ExtendReportEnd() throws IOException {
		extentReportTearDown("F:\\Java_Workspace\\SalixProject\\SalixPharmaceuticals\\Reports\\index.html");
	}
